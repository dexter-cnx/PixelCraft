...
const editorAdjustmentSpecs = <EditorAdjustmentSpec>[
  ...
  EditorAdjustmentSpec(id: 'brightness', label: 'Brightness', min: 0, max: 2, neutral: 1, group: 'Light', gpuPreview: true),
  EditorAdjustmentSpec(id: 'contrast', label: 'Contrast', min: 0, max: 2, neutral: 1, group: 'Light', gpuPreview: true),
  ...
  EditorAdjustmentSpec(id: 'saturation', label: 'Saturation', min: 0, max: 2, neutral: 1, group: 'Color', gpuPreview: true),
  ...
  EditorAdjustmentSpec(id: 'sharpen', label: 'Sharpness', min: 0, max: 2, neutral: 0, group: 'Detail', gpuPreview: true),
  EditorAdjustmentSpec(id: 'gaussian_blur', label: 'Gaussian Blur', min: 0, max: 2, neutral: 0, group: 'Detail', gpuPreview: true),
];
